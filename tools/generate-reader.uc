...
let GeneratorProto = {
	...
	generate: function(file)
	{
		...
		this.emit_spec_validation_function(indent, 'new', "URenderState", this.schema);

		this.print(indent, 'export function validate(value, errors) {');
		this.print(indent, '	let err = [];');
		this.print(indent, '	let res = newURenderState("", value, err);');
	...
	module: function(module)
	{
		...
		this.output = fs.open('uReader/' + to_method_name('schema', module) + '.uc', 'w');
